          ...
          <div className="flex gap-4">
            <div className="w-52 flex ite justify-between text-gray-500 gap-4 border p-3">
              ...
              <div className="flex items-center gap-4 text-sm font-semibold">
                <button onClick={decreaseQuantity} className="border h-5 font-normal text-lg flex items-center justify-center px-2 hover:bg-gray-700 hover:text-white cursor-pointer duration-300 active:bg-black">-</button>
